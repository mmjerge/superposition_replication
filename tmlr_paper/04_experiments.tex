...
\paragraph{Architecture.} We use a transformer with the following configuration:
\begin{itemize}
    \item Hidden dimension: 64
    \item Number of layers: 4
    \item Attention heads: 4
    \item Positions: 32
    \item Input features: 128 (exceeding hidden dimension to encourage superposition)
\end{itemize}
