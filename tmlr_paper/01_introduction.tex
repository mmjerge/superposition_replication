...
\begin{enumerate}
    ...
    \item \textbf{Unified framework}: A theoretical connection between \emph{representational superposition} \citep{elhage2022toy} and \emph{reasoning superposition} in continuous chain-of-thought \citep{hao2024training, zhu2025reasoning}, showing both are instances of a general capacity-management principle.
